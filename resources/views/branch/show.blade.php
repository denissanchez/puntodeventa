...
<div id="generateReport" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="generateReportModal" aria-hidder="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content" id="modal-content_generate-report">
        </div>
    </div>
</div>

<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.22.1/moment.min.js"></script>
<script src="{{ asset('js/drp.js') }}"></script>


<script type="application/javascript">
    function openModal() {
        $('#modal-content_generate-report').html('');
        $('#generateReport').modal('show');
        axios.get("{{ route('partial.modal.report') }}").then(
            res => {
                $('#modal-content_generate-report').html(res.data);
            },
            err => {
